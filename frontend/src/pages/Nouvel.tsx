    ...
    <>
      ...
      <div className="screen">
        ...
        <p style={{ color: "var(--text-muted)", fontSize: 13, marginTop: 0 }}>
          {lis.length} nouvèl ant 15-80km de ou.
        </p>
        ...
        {lisKlase.map(({ rapò, distKm }) => {
          ...
          return (
            <div
              ...
              style={{ cursor: "pointer", opacity: li ? 0.72 : 1, borderColor: li ? "var(--border)" : "var(--official)" }}
              onClick={() => louvri(rapò.id)}
            >
              {!li && (
                <span
                  style={{
                    width: 8, height: 8, borderRadius: "50%", background: "var(--official)",
